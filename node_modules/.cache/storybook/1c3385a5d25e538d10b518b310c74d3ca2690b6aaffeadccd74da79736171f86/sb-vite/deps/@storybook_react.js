...
import {
  ...
  wt,
  ya
} from "./chunk-I3ZGSUWU.js";
import "./chunk-KQ2JNRIV.js";
import {
  entry_preview_exports,
  renderToCanvas
} from "./chunk-UVEHT7MR.js";
import "./chunk-KW2YJWSS.js";
import {
  require_react
...
import "./chunk-5ZEB6EXB.js";
import {
  require_global
} from "./chunk-DXIOBCSA.js";
import {
  require_preview_api
} from "./chunk-BLZGXYGP.js";
import {
  __toESM
...
var require_ast = __commonJS({ "../../node_modules/esutils/lib/ast.js"(exports, module2) {
  (function() {
    ...
    module2.exports = { isExpression, isStatement, isIterationStatement, isSourceElement, isProblematicIfStatement, trailingStatement };
  })();
} });
var require_code = __commonJS({ "../../node_modules/esutils/lib/code.js"(exports, module2) {
  (function() {
    ...
    module2.exports = { isDecimalDigit: isDecimalDigit2, isHexDigit: isHexDigit2, isOctalDigit: isOctalDigit2, isWhiteSpace, isLineTerminator, isIdentifierStartES5, isIdentifierPartES5, isIdentifierStartES6, isIdentifierPartES6 };
  })();
} });
var require_keyword = __commonJS({ "../../node_modules/esutils/lib/keyword.js"(exports, module2) {
  (function() {
    ...
    module2.exports = { isKeywordES5, isKeywordES6, isReservedWordES5, isReservedWordES6, isRestrictedWord, isIdentifierNameES5, isIdentifierNameES6, isIdentifierES5, isIdentifierES6 };
  })();
} });
...
var require_package = __commonJS({ "../../node_modules/escodegen/package.json"(exports, module2) {
  module2.exports = { name: "escodegen", description: "ECMAScript code generator", homepage: "http://github.com/estools/escodegen", main: "escodegen.js", bin: { esgenerate: "./bin/esgenerate.js", escodegen: "./bin/escodegen.js" }, files: ["LICENSE.BSD", "README.md", "bin", "escodegen.js", "package.json"], version: "2.1.0", engines: { node: ">=6.0" }, maintainers: [{ name: "Yusuke Suzuki", email: "utatane.tea@gmail.com", web: "http://github.com/Constellation" }], repository: { type: "git", url: "http://github.com/estools/escodegen.git" }, dependencies: { estraverse: "^5.2.0", esutils: "^2.0.2", esprima: "^4.0.1" }, optionalDependencies: { "source-map": "~0.6.1" }, devDependencies: { acorn: "^8.0.4", bluebird: "^3.4.7", "bower-registry-client": "^1.0.0", chai: "^4.2.0", "chai-exclude": "^2.0.2", "commonjs-everywhere": "^0.9.7", gulp: "^4.0.2", "gulp-eslint": "^6.0.0", "gulp-mocha": "^7.0.2", minimist: "^1.2.5", optionator: "^0.9.1", semver: "^7.3.4" }, license: "BSD-2-Clause", scripts: { test: "gulp travis", "unit-test": "gulp test", lint: "gulp lint", release: "node tools/release.js", "build-min": "./node_modules/.bin/cjsify -ma path: tools/entry-point.js > escodegen.browser.min.js", build: "./node_modules/.bin/cjsify -a path: tools/entry-point.js > escodegen.browser.js" } };
} });
...
var require_acorn_jsx = __commonJS({ "../../node_modules/acorn-jsx/index.js"(exports, module2) {
  ...
  Object.defineProperty(module2.exports, "tokTypes", { get: function() {
...
function isPlainObject(object) {
  ...
  if (Object.prototype.toString.call(object) !== "[object Object]") {
    ...
    return tag == null || !((_a2 = Object.getOwnPropertyDescriptor(object, Symbol.toStringTag)) == null ? void 0 : _a2.writable) ? false : object.toString() === `[object ${tag}]`;
  }
  let proto = object;
...
// node_modules/@storybook/react/dist/chunk-JL2J6OGA.mjs
var import_preview_api = __toESM(require_preview_api(), 1);
function __definePreview(input) {
  let composed, preview = { _tag: "Preview", input, get composed() {
    if (composed) return composed;
    let { addons, ...rest } = input;
    return composed = (0, import_preview_api.normalizeProjectAnnotations)((0, import_preview_api.composeConfigs)([...(0, import_preview_api.getCoreAnnotations)(), ...addons ?? [], rest])), composed;
  }, meta(meta) {
...
function defineMeta(input, preview) {
  return { _tag: "Meta", input, preview, get composed() {
...
function defineStory(input, meta) {
  return { _tag: "Story", input, meta, get composed() {
    throw new Error("Not implemented");
  } };
}
function __definePreview2(preview) {
  return __definePreview({ ...preview, addons: [entry_preview_exports, entry_preview_argtypes_exports, entry_preview_docs_exports, ...preview.addons ?? []] });
}
...
function setProjectAnnotations(projectAnnotations) {
  return (0, import_preview_api2.setDefaultProjectAnnotations)(INTERNAL_DEFAULT_PROJECT_ANNOTATIONS), (0, import_preview_api2.setProjectAnnotations)(projectAnnotations);
}
var INTERNAL_DEFAULT_PROJECT_ANNOTATIONS = (0, import_preview_api2.composeConfigs)([entry_preview_exports, entry_preview_argtypes_exports, { renderToCanvas: async (renderContext, canvasElement) => {
...
function composeStory(story, componentAnnotations, projectAnnotations, exportsName) {
  return (0, import_preview_api2.composeStory)(story, componentAnnotations, projectAnnotations, globalThis.globalProjectAnnotations ?? INTERNAL_DEFAULT_PROJECT_ANNOTATIONS, exportsName);
}
...
export {
  ...
  __definePreview2 as __definePreview,
  composeStories,
  composeStory,
